...
const {createMenuSchema, updateMenuSchema, updateAvailabilitySchema, getMenuByIdSchema} = require("../validators/manu.validator");
...
router.patch("/:id/availability", authenticate, authorize("MANAGER"),validate(updateAvailabilitySchema), menuController.toggleAvailablity);
